        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-6xl w-full">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-6">
            ...
            <div className="flex flex-col space-y-6 text-left px-4">
              <h2 className="text-3xl font-semibold text-gray-900">Playwood Arm Chair</h2>
              ...
              <p className="text-sm font-semibold text-gray-800">
                $32.00 <span className="pl-2 line-through text-pink-500">$40.00</span>
              </p>
              ...
              <button className="mt-4 px-6 py-3 text-[#151875] text-center hover:bg-pink-500 flex items-center justify-center transition">
                Add to Cart
                <Heart className="text-[#151875] px-1" />
              </button>
              <div className="mt-4">
                <p className="text-[#151875] font-bold text-sm">Categories:</p>
                <p className="text-[#151875] font-bold text-sm">Tags</p>
                <p className="text-[#151875] font-bold text-sm">Share:</p>
              </div>
            </div>
          </div>
        </div>
