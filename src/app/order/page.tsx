...
export default function OrderCompleted() {
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 lg:px-20">

        {/* Order Completed Section */}
        <div className="bg-white p-8 sm:p-10 rounded-lg text-center max-w-3xl mx-auto">
          {/* Icons */}
        ...
        {/* Footer Image */}
        <div className="mt-8">
          <Image src="/bg2.png" alt="footerimg" width={900} height={93} className="mx-auto" />
        </div>
      </div>
    </>
  );
